...
def main():
    ...
    while not game_end:
        ...
        # FOR DEBUG PURPOSES
        board_1 = np.array(game_board)
        board_1 = np.flip(board_1,0)
        ...
        # minmax return column and value i need only column
        bestColumn = minimax(board_1, 4, -math.inf, math.inf,True)[0]
